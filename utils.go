...
const (
	...
	HTTPHeadeBfsContentLength = "X-Bfs-Content-Length"
	HTTPHeaderTransactionMsg  = "X-Bfs-Txn-Msg"
	HTTPHeaderTransactionHash = "X-Bfs-Txn-Hash"
	HTTPHeaderTransactionDate = "X-Bfs-Txn-Date"
	HTTPHeaderResource        = "X-Bfs-Resource"
	HTTPHeaderPreSignature    = "X-Bfs-Pre-Signature"
	HTTPHeaderDate            = "X-Bfs-Date"
	HTTPHeaderEtag            = "ETag"
	HTTPHeaderHost            = "Host"
